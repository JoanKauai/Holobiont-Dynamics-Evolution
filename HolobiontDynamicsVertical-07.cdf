...
NotebookDataLength[     64417,       1363]
NotebookOptionsPosition[     64584,       1354]
NotebookOutlinePosition[     64921,       1369]
CellTagsIndexPosition[     64878,       1366]
WindowFrame->Normal*)
...
Cell[BoxData[
 RowBox[{"(*", " ", 
  RowBox[{
   RowBox[{"HolobiontDynamicsVertical", "-", "07"}], ",", " ", 
   RowBox[{"July", " ", "19"}], ",", " ", 
   RowBox[{
 ...
 CellChangeTimes->{{3.74266174565221*^9, 3.742661836014979*^9}, {
   ...
   3.772564241865981*^9, 3.7725642863579407`*^9}, {3.772564379506866*^9, 
   3.772564387882859*^9}, {3.772564888373767*^9, 
   3.772564905455188*^9}},ExpressionUUID->"14bf564c-a17f-4de0-8377-\
0ca28270b31e"],
...
Cell[BoxData[
 RowBox[{
  ...
  RowBox[{"Module", "[", 
   RowBox[{
    RowBox[{"{", " ", 
     RowBox[{
     "F", ",", "Fiterate", ",", "nprimeprime", ",", " ", "nprime", ",", 
      "Hprime", ",", "Hprimeprime", ",", "W", ",", "\[IndentingNewLine]", 
 ...
 CellChangeTimes->{{3.742337553500803*^9, 3.742337567314199*^9}, {
   ...
   3.74605020168042*^9, 3.746050238446121*^9}, {3.772564357562909*^9, 
   3.772564371071204*^9}, {3.772564469771019*^9, 3.77256446992635*^9}, {
   3.772564578177877*^9, 
   3.772564580901091*^9}},ExpressionUUID->"dc86d10c-ca2b-4121-ad80-\
5fa029a3fad9"],
     ...
     RowBox[{
      ...
      RowBox[{"{", 
       RowBox[{"\"\<\>\"", ",", 
        RowBox[{"Style", "[", 
         RowBox[{
         "\"\<Vertical Transmission, One Host Niche, One Microbial Taxon\>\"",
           ",", "14", ",", "Bold"}], "]"}]}], "}"}]}], "}"}]}]}], 
  "]"}]], "Input",
 CellOpen->False,
 CellChangeTimes->{
  3.7424041877671556`*^9, {3.742404250852807*^9, 3.7424043055010223`*^9}, {
   ...
   3.7725644186873827`*^9, 3.772564427185183*^9}, {3.772564469928062*^9, 
   3.772564469935852*^9}},
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`DisplayOption$$ = 2, $CellContext`Init$$ = 
    2, $CellContext`k$$ = 20, $CellContext`m$$ = Rational[
    1, 8], $CellContext`r$$ = 0.025, $CellContext`tm$$ = 
    ...
    Typeset`skipInitDone$$ = False, $CellContext`tM$3576$$ = 
    0, $CellContext`tm$3577$$ = 0, $CellContext`m$3578$$ = 
    0, $CellContext`r$3579$$ = 0, $CellContext`k$3580$$ = 
    0, $CellContext`W0$3581$$ = 0, $CellContext`Wk$3582$$ = 
    0, $CellContext`Init$3583$$ = 0, $CellContext`DisplayOption$3584$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`DisplayOption$$ = 2, $CellContext`Init$$ = 
        2, $CellContext`k$$ = 20, $CellContext`m$$ = 
        Rational[1, 8], $CellContext`r$$ = 0.025, $CellContext`tm$$ = 
        3, $CellContext`tM$$ = 11, $CellContext`W0$$ = 2, $CellContext`Wk$$ = 
        0}, "ControllerVariables" :> {
        Hold[$CellContext`tM$$, $CellContext`tM$3576$$, 0], 
        Hold[$CellContext`tm$$, $CellContext`tm$3577$$, 0], 
        Hold[$CellContext`m$$, $CellContext`m$3578$$, 0], 
        Hold[$CellContext`r$$, $CellContext`r$3579$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$3580$$, 0], 
        Hold[$CellContext`W0$$, $CellContext`W0$3581$$, 0], 
        Hold[$CellContext`Wk$$, $CellContext`Wk$3582$$, 0], 
        Hold[$CellContext`Init$$, $CellContext`Init$3583$$, 0], 
        Hold[$CellContext`DisplayOption$$, $CellContext`DisplayOption$3584$$, 
         0]}, "OtherVariables" :> {
...
$CellContext`tm$$, $CellContext`m$$, $CellContext`r$$, $CellContext`k$$, \
$CellContext`W0$$, $CellContext`Wk$$, $CellContext`Init$$, \
$CellContext`DisplayOption$$], 
      "Specifications" :> {{{$CellContext`tM$$, 11, "tM, Macro Time Steps"}, 
         ...
         "Labeled"}}, "Options" :> {FrameLabel -> {{"", ""}, {"", 
           Style[
           "Vertical Transmission, One Host Niche, One Microbial Taxon", 14, 
            Bold]}}}, "DefaultOptions" :> {}],
         ...
         If[$CellContext`Init == 1, $CellContext`H = {
           ...
           If[$CellContext`Init == 2, $CellContext`H = {
            ...
            If[$CellContext`Init == 3, $CellContext`H = {
               ...
               Table[
               0, {$CellContext`n, 0, $CellContext`k}]}]]]; $CellContext`HT = {
            Total[
             Part[$CellContext`H, 1]]}; $CellContext`GT = {
            
            Sum[$CellContext`n 
             Part[$CellContext`H, 1, $CellContext`n + 1], {$CellContext`n, 
              0, $CellContext`k}]}; $CellContext`F[
         ...
         For[$CellContext`t = 1, $CellContext`t <= $CellContext`tM, 
           PreIncrement[$CellContext`t], $CellContext`nprime = Table[
              If[Part[$CellContext`HT, $CellContext`t] > 0, 
               ...
               0], {$CellContext`n, 0, $CellContext`k}]; $CellContext`Hprime = 
            Table[
              Total[
               Part[
...
{$CellContext`n, 0, $CellContext`k}]; $CellContext`Hprimeprime = Table[
              Total[
...
$CellContext`m, $CellContext`r, $CellContext`k, $CellContext`W0, \
$CellContext`Wk}]; If[$CellContext`DisplayOption == 1, 
...
$CellContext`SymbiontNumberPlot, $CellContext`HolobiontFitnessPlot}], Frame -> 
 ...
 CellChangeTimes->{
  3.7460367635106363`*^9, 3.7460373078017597`*^9, {3.746037835267351*^9, 
   ...
   3.7462907931606207`*^9, 3.772487840791586*^9, 3.7725645163453283`*^9},
 CellLabel->"Out[4]=",ExpressionUUID->"2d95bd64-bb46-4573-b667-c4af203bd5f4"]
}, Open  ]]
},
WindowSize->{1628, 951},
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 1353, 23, 30, "Input",ExpressionUUID->"14bf564c-a17f-4de0-8377-0ca28270b31e"],
Cell[2844, 58, 172, 3, 19, "Input",ExpressionUUID->"9e7a2b49-8641-463d-94e7-51e2f062a5cb",
 CellOpen->False],
Cell[3019, 63, 37841, 811, 19, "Input",ExpressionUUID->"dc86d10c-ca2b-4121-ad80-5fa029a3fad9",
 CellOpen->False],
Cell[CellGroupData[{
Cell[40885, 878, 6787, 141, 19, "Input",ExpressionUUID->"957b400d-0338-4577-8cdc-f4e902ee69b6",
 CellOpen->False],
Cell[47675, 1021, 16893, 330, 674, "Output",ExpressionUUID->"2d95bd64-bb46-4573-b667-c4af203bd5f4"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature 0wpGfxfBEYetHCKkSNpyYPwI *)
