...
NotebookDataLength[     65483,       1372]
NotebookOptionsPosition[     65652,       1363]
NotebookOutlinePosition[     65989,       1378]
CellTagsIndexPosition[     65946,       1375]
WindowFrame->Normal*)
...
Cell[BoxData[
 RowBox[{"(*", " ", 
  RowBox[{
   RowBox[{"HolobiontDynamicsHorizontal", "-", "07"}], ",", " ", 
   RowBox[{"July", " ", "19"}], ",", " ", 
   RowBox[{
   "2019.", " ", "Copyright", " ", "by", " ", "Joan", " ", "Rougharden"}]}], 
  " ", "*)"}]], "Input",
 CellChangeTimes->CompressedData["
1:eJxTTMoPSmViYGAQAWIQ/eKeSV//o9eOW6saZoJoFvXOxSA6KCxlCYh+l71t
...
jrPYN2mD6Bk1PktA9L0i1mUgurDhzjoQPaeNaz2IZnY6rTxT+o2jg6eQOogG
AIHDqsE=
  "],
  ...
  RowBox[{
   ...
   RowBox[{"Module", "[", 
    RowBox[{
     RowBox[{"{", " ", 
      RowBox[{
      "F", ",", "Fiterate", ",", "nprimeprime", ",", " ", "MU", ",", "MUinit",
        ",", " ", "nprime", ",", "Hprime", ",", "Hprimeprime", ",", "W", ",", 
       " ", "ShortFall", ",", "HolobiontFitnessPlot", ",", 
       "HolobiontNumberPlot", ",", " ", "SymbiontNumberPlot", ",", 
       "\[IndentingNewLine]", "ChartColor", ",", " ", "HostPopulationColor", 
       ",", "GuestPopulationColor", ",", "HCharts", ",", "HGraphsGrid", ",", 
       "PictureGridList"}], " ", "}"}], ",", "\[IndentingNewLine]", 
     RowBox[{
      RowBox[{"If", "[", 
       RowBox[{
        RowBox[{"Init", "\[Equal]", "1"}], ",", 
...
, " ", "*)"}], "\[IndentingNewLine]", 
 ...
 CellChangeTimes->{{3.742337553500803*^9, 3.742337567314199*^9}, {
   ...
   3.7462905998051863`*^9, 3.746290603076961*^9}, {3.7725658287453814`*^9, 
   3.77256586170126*^9}},
      ...
      RowBox[{
       ...
       RowBox[{"{", 
        RowBox[{"\"\<\>\"", ",", 
         RowBox[{"Style", "[", 
          RowBox[{
          "\"\<Horizontal Transmission, One Host Niche, One Microbial Taxon\>\
\"", ",", "14", ",", "Bold"}], "]"}]}], "}"}]}], "}"}]}]}], "]"}]}]], "Input",\
 ...
 CellChangeTimes->{{3.745447880666585*^9, 3.7454479132821493`*^9}, {
  ...
  3.7462908229439993`*^9}, {3.772565861705245*^9, 3.772565884214673*^9}},
 CellLabel->"In[4]:=",ExpressionUUID->"72643ee9-6abd-47ab-8c1c-a419c6ff0390"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`DisplayOption$$ = 2, $CellContext`Init$$ = 
    2, $CellContext`k$$ = 20, $CellContext`r$$ = 0.025, $CellContext`tm$$ = 
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       ...
       Hold[$CellContext`k$$], 20, "k, Microbial Logistic k"}, 1, 40, 1}, {{
    ...
    540., {277., 281.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`tM$2786$$ = 
    0, $CellContext`tm$2787$$ = 0, $CellContext`r$2788$$ = 
    0, $CellContext`k$2789$$ = 0, $CellContext`W0$2790$$ = 
    0, $CellContext`Wk$2791$$ = 0, $CellContext`Init$2792$$ = 
    0, $CellContext`DisplayOption$2793$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`DisplayOption$$ = 2, $CellContext`Init$$ = 
        ...
        Hold[$CellContext`tM$$, $CellContext`tM$2786$$, 0], 
        Hold[$CellContext`tm$$, $CellContext`tm$2787$$, 0], 
        Hold[$CellContext`r$$, $CellContext`r$2788$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$2789$$, 0], 
        Hold[$CellContext`W0$$, $CellContext`W0$2790$$, 0], 
        Hold[$CellContext`Wk$$, $CellContext`Wk$2791$$, 0], 
        Hold[$CellContext`Init$$, $CellContext`Init$2792$$, 0], 
        Hold[$CellContext`DisplayOption$$, $CellContext`DisplayOption$2793$$, 
         0]}, "OtherVariables" :> {
...
$CellContext`tm$$, $CellContext`r$$, $CellContext`k$$, $CellContext`W0$$, \
$CellContext`Wk$$, $CellContext`Init$$, $CellContext`DisplayOption$$], 
      "Specifications" :> {{{$CellContext`tM$$, 11, "tM, Macro Time Steps"}, 
         ...
         "Labeled"}, {{$CellContext`r$$, 0.025, "r, Microbial Logistic r"}, 0,
          1, Appearance -> 
         "Labeled"}, {{$CellContext`k$$, 20, "k, Microbial Logistic k"}, 1, 
         40, 1, Appearance -> 
         ...
         "Labeled"}}, "Options" :> {FrameLabel -> {{"", ""}, {"", 
           Style[
           "Horizontal Transmission, One Host Niche, One Microbial Taxon", 14,
             Bold]}}}, "DefaultOptions" :> {}],
     ImageSizeCache->{1021., {325., 330.}},
...
$CellContext`HGraphsGrid, $CellContext`PictureGridList}, 
         If[$CellContext`Init == 1, $CellContext`Hinit = 
           Table[$CellContext`k + 
             1 - $CellContext`n, {$CellContext`n, 0, $CellContext`k}], 
           
           If[$CellContext`Init == 2, $CellContext`Hinit = 
            Table[10, {$CellContext`n, 0, $CellContext`k}], 
            
            If[$CellContext`Init == 3, $CellContext`Hinit = 
             Table[$CellContext`n, {$CellContext`n, 
                0, $CellContext`k}], $CellContext`H = 
             Table[0, {$CellContext`n, 
                0, $CellContext`k}]]]]; $CellContext`HTinit = 
          Total[$CellContext`Hinit]; $CellContext`GTinit = 
          Sum[$CellContext`n 
            Part[$CellContext`Hinit, $CellContext`n + 1], {$CellContext`n, 
             0, $CellContext`k}]; $CellContext`MUinit = \
...
{$CellContext`n, 0, $CellContext`k}]/N[
                CDF[
                 
                 PoissonDistribution[$CellContext`MUinit], $CellContext`k]]] \
$CellContext`HTinit]}; $CellContext`F[
            Pattern[$CellContext`n, 
             Blank[]]] := (
            1 + $CellContext`r - $CellContext`r \
($CellContext`n/$CellContext`k)) $CellContext`n; $CellContext`Fiterate[
            Pattern[$CellContext`n, 
             Blank[]]] := Simplify[
...
$CellContext`nprimeprime = Table[
            Round[
             $CellContext`Fiterate[$CellContext`n]], {$CellContext`n, 
             0, $CellContext`k}]; 
         If[$CellContext`k > 0, $CellContext`W = 
           Table[$CellContext`W0 + (($CellContext`Wk - \
$CellContext`W0)/$CellContext`k) $CellContext`n, {$CellContext`n, 
              0, $CellContext`k}], $CellContext`W = 
           Table[0, {$CellContext`n, 0, $CellContext`k}]]; 
         For[$CellContext`t = 1, 
...
{$CellContext`n, 0, $CellContext`k}]/N[
                 CDF[
                  PoissonDistribution[$CellContext`MU], $CellContext`k]]] 
...
{$CellContext`n, 0, $CellContext`k}]; $CellContext`H = 
            Append[$CellContext`H, 
            ...
            Append[$CellContext`GT, 
              ...
              Sum[$CellContext`n 
               Part[$CellContext`H, $CellContext`t + 1, $CellContext`n + 
                 1], {$CellContext`n, 0, $CellContext`k}]]; 
           Null]; $CellContext`H = 
          Append[$CellContext`H, {$CellContext`tM, $CellContext`tm, \
$CellContext`r, $CellContext`k, $CellContext`W0, $CellContext`Wk}]; 
...
$CellContext`GuestPopulationColor = 
            ...
            ListLinePlot[
              Table[{$CellContext`n, 
                Part[$CellContext`W, $CellContext`n + 1]}, {$CellContext`n, 
                0, $CellContext`k}], Frame -> True, PlotLabel -> 
              "Holobiont Fitness", 
...
$CellContext`SymbiontNumberPlot, $CellContext`HolobiontFitnessPlot}], Frame -> 
 ...
 CellChangeTimes->{
  3.745688137663578*^9, 3.745688360391148*^9, 3.746290065124735*^9, 
   ...
   3.7462908281802883`*^9, 3.7462922155896177`*^9, 3.772488915748603*^9, 
   3.7725659199905787`*^9},
 CellLabel->"Out[4]=",ExpressionUUID->"c0c17f92-1465-4ddf-9027-19fc1ab04fff"]
}, Open  ]]
},
WindowSize->{1626, 975},
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 765, 17, 30, "Input",ExpressionUUID->"14bf564c-a17f-4de0-8377-0ca28270b31e"],
Cell[2256, 52, 172, 3, 19, "Input",ExpressionUUID->"9e7a2b49-8641-463d-94e7-51e2f062a5cb",
 CellOpen->False],
Cell[2431, 57, 42012, 862, 19, "Input",ExpressionUUID->"dc86d10c-ca2b-4121-ad80-5fa029a3fad9",
 CellOpen->False],
Cell[CellGroupData[{
Cell[44468, 923, 4160, 99, 19, "Input",ExpressionUUID->"72643ee9-6abd-47ab-8c1c-a419c6ff0390",
 CellOpen->False],
Cell[48631, 1024, 17005, 336, 674, "Output",ExpressionUUID->"c0c17f92-1465-4ddf-9027-19fc1ab04fff"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature Wx0dn0nhspINNAgyEUXzO@XK *)
